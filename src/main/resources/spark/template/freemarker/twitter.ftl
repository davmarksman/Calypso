...
<head>
    ...
    <!--<link rel="stylesheet" type="text/css" href="/stylesheets/twit.css" />-->
    ...
    <script type="text/javascript" src="javascript/codebird.js"></script>
    <script type="text/javascript" src="/javascript/twitter.js"></script>
</head>

<body>

<span id="titleTwit" class="first">
			@marceloag
		</span>
<ul class="timeline">
    <li>
